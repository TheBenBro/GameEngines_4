...
void ShaderHandler::CreateProgram(const std::string& shaderName_, const std::string& vertexShaderFileName_, const std::string& fragmentShaderFileName_)
{
    ...
    GLuint vertexShader = CreatShader(GL_VERTEX_SHADER,
        vertexShaderCode, shaderName_);
    GLuint fragmentShader = CreatShader(GL_FRAGMENT_SHADER,
...
GLuint ShaderHandler::CreatShader(GLenum shaderType_, const std::string& source_, const std::string& shaderName_)
{
